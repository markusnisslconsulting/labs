...
export default {
  ...
  explanation: [
    ...
    "Storybook runs an accessibility check on every story through the a11y addon, so contrast and landmark violations surface while the component is being written, not after a lab ships.",
  ],
