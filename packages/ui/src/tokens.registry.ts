...
export const primitiveTokens: TokenDescriptor[] = [
  ...
  t("--uix-black", "#000000", "primitive", "color", "Pure black; the scrim needs a value darker than the darkest surface"),
  ...
  t("--uix-font-serif", "Charter, \"Iowan Old Style\", \"Hoefler Text\", Palatino, Georgia, serif", "primitive", "typography", "Font serif"),
  ...
  t("--uix-line-height-loose", "1.7", "primitive", "typography", "Loose line height for long-form prose"),
  t("--uix-tracking-tight", "-0.01em", "primitive", "typography", "Tracking, tight"),
  t("--uix-tracking-none", "0", "primitive", "typography", "Tracking, none"),
  t("--uix-tracking-wide", "0.14em", "primitive", "typography", "Tracking, wide (uppercase labels)"),
...
export const semanticTokens: TokenDescriptor[] = [
  ...
  t("--uix-bg-raised", "light-dark(var(--uix-white), var(--uix-slate-600))", "semantic", "color", "A surface above the one behind it; lighter than bg-subtle in both themes"),
  ...
  t("--uix-scrim", "light-dark(color-mix(in srgb, var(--uix-navy-900) 45%, transparent), color-mix(in srgb, var(--uix-black) 65%, transparent))", "semantic", "color", "The wash behind a modal; always darkens, in both themes"),
  ...
  t("--uix-font-ui", "var(--uix-font-sans)", "semantic", "typography", "Controls, labels and fields"),
  t("--uix-leading-display", "var(--uix-line-height-tight)", "semantic", "typography", "Heading leading"),
  t("--uix-leading-body", "var(--uix-line-height-normal)", "semantic", "typography", "Running text leading"),
  t("--uix-tracking-display", "var(--uix-tracking-tight)", "semantic", "typography", "Heading tracking"),
  t("--uix-tracking-ui", "var(--uix-tracking-wide)", "semantic", "typography", "Uppercase label tracking"),
  t("--uix-weight-display", "var(--uix-font-weight-bold)", "semantic", "typography", "Heading weight"),
  t("--uix-weight-ui", "var(--uix-font-weight-bold)", "semantic", "typography", "Label and control weight"),
  ...
  t("--uix-text-display", "var(--uix-font-size-600)", "semantic", "typography", "Page-title text role"),
...
export const componentTokens: TokenDescriptor[] = [
  ...
  t("--uix-appshell-nav", "15rem", "component", "space", "How wide an application's navigation rail sits"),
  t("--uix-split-side", "18rem", "component", "space", "Preferred width of a Split's narrow half"),
  t("--uix-split-main-min", "24rem", "component", "space", "Width a Split's wide half needs before the two stack"),
  t("--uix-columns-min", "17rem", "component", "space", "Narrowest a Columns column gets before the row drops one"),
  t("--uix-measure-prose", "68ch", "component", "space", "Reading width for running text"),
  t("--uix-measure-app", "80rem", "component", "space", "Widest a page's content grows"),
  t("--uix-page-gutter", "var(--uix-gap-lg)", "component", "space", "The space between a page's content and the viewport edge"),
  ...
  t("--uix-switch-thumb-bg", "var(--uix-bg-raised)", "component", "color", "Switch knob"),
  t("--uix-segment-on-bg", "var(--uix-bg-raised)", "component", "color", "Fill of the selected segment"),
