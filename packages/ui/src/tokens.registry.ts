...
export const primitiveTokens: TokenDescriptor[] = [
  ...
  t("--uix-shadow-1", "0 1px 3px rgba(16, 24, 40, 0.1)", "primitive", "elevation", "Resting card"),
  t("--uix-shadow-2", "0 8px 20px rgba(16, 24, 40, 0.12)", "primitive", "elevation", "Hover / dropdown"),
  t("--uix-shadow-3", "0 18px 45px rgba(16, 24, 40, 0.2)", "primitive", "elevation", "Dialog"),
...
export const semanticTokens: TokenDescriptor[] = [
  ...
  t("--uix-text-disabled", "var(--uix-slate-500)", "semantic", "color", "Text belonging to an unavailable control"),
  ...
  t("--uix-ink", "var(--uix-navy-900)", "semantic", "color", "Strongest ink for this theme; mix toward it to deepen a fill"),
  ...
  t("--uix-elevation-raised", "var(--uix-shadow-1)", "semantic", "elevation", "Lifted off the page"),
  t("--uix-elevation-overlay", "var(--uix-shadow-2)", "semantic", "elevation", "Floating above the page"),
  t("--uix-elevation-modal", "var(--uix-shadow-3)", "semantic", "elevation", "Above everything"),
